...
An identity includes the folded name, sex, country, and disambiguation number. Use `Disambiguation` only for confirmed different people who otherwise share those fields. Leave the first person's value empty and number the others from `2`.
