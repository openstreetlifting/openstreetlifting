  ...
  <div class="prose max-w-none prose-invert">
    <section class="mb-12">
      ...
      <p class="mb-4 leading-relaxed font-light text-zinc-400">
        OpenStreetlifting is an open source project committed to protecting your
    ...
    <section class="mb-12">
      ...
      <p class="mb-4 leading-relaxed font-light text-zinc-400">
        ...
        OpenStreetlifting project. For any privacy-related inquiries, you can
        contact us at:
      </p>
    ...
    <section class="mb-12">
      ...
      <p class="mb-4 leading-relaxed font-light text-zinc-400">
        We use Umami Analytics, a privacy-focused, open source analytics
        platform that respects your privacy. Umami collects only anonymous,
      ...
      <p class="mb-4 leading-relaxed font-light text-zinc-400">
        Umami does not use cookies, does not track you across websites, does not
        collect personal information, and does not store IP addresses. All data
        is anonymized and cannot be used to identify individual users.
      </p>

      <h3 class="mb-3 text-xl font-medium text-white">User-Submitted Data</h3>
      <p class="mb-4 leading-relaxed font-light text-zinc-400">
        If you submit competition results or athlete data to our platform, we
        collect and store the information you provide. The transformed data is
        licensed under <a
    ...
    <section class="mb-12">
      ...
      <ul class="mb-4 space-y-2 text-zinc-400">
        ...
        <li class="font-light">
          <strong class="font-medium text-zinc-300">Consent:</strong> When you voluntarily
          submit data to our platform
        </li>
      </ul>
    </section>
    ...
    <section class="mb-12">
      ...
      <p class="mb-4 leading-relaxed font-light text-zinc-400">
        All competition and athlete data submitted to OpenStreetlifting is
        publicly available as part of our open database. We do not sell, rent,
    ...
    <section class="mb-12">
      ...
      <ul class="mb-4 space-y-2 text-zinc-400">
        <li class="font-light">
          <strong class="font-medium text-zinc-300">Right to access:</strong> Request
        ...
        <li class="font-light">
          <strong class="font-medium text-zinc-300">Right to erasure:</strong> Request
          deletion of your personal data
        </li>
        <li class="font-light">
          <strong class="font-medium text-zinc-300"
            >Right to restriction:</strong
        ...
        <li class="font-light">
          <strong class="font-medium text-zinc-300">Right to object:</strong> Object
    ...
    <section class="mb-12">
      ...
      <p class="mb-4 leading-relaxed font-light text-zinc-400">
        Anonymous analytics data is retained indefinitely for statistical
        purposes. User-submitted competition and athlete data becomes part of
        our permanent public archive, as this is the core purpose of the
        OpenStreetlifting project.
      </p>
    </section>
    ...
    <section class="mb-12">
      ...
      <p class="mb-4 leading-relaxed font-light text-zinc-400">
        This website does not use cookies. Umami Analytics operates without
        cookies and does not require cookie consent banners.
      </p>
    </section>
      ...
      <ul class="space-y-2 text-zinc-400">
        ...
        <li class="font-light">
          GitHub: <a
            ...
            rel="noopener noreferrer"
            class="text-zinc-300 transition-colors hover:text-white"
            >github.com/openstreetlifting</a
          >
        </li>
      </ul>
    </section>
